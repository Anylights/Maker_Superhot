...
function Standalone.Start()
    ...
    renderer.defaultZone.fogColor = Color(0.15, 0.10, 0.35)  -- Astroon 提亮 $background
...
function Standalone.CreateScene()
    ...
    if lightGroupFile then
        ...
        if zoneComp then
            zoneComp.fogColor = Color(0.15, 0.10, 0.35)  -- Astroon 提亮 $background
        end
    else
...
function Standalone.CreateFallbackLighting()
    ...
    zone.fogColor = Color(0.15, 0.10, 0.35)  -- Astroon 提亮 $background
    zone.fogStart = 80.0
    zone.fogEnd = 150.0
