...
Config.PlayerColors = {
    Color(1.00, 0.30, 0.25, 1.0),  -- 番茄红（提亮）
    Color(0.30, 0.55, 1.00, 1.0),  -- 宝蓝（提亮）
    Color(0.25, 0.95, 0.42, 1.0),  -- 翠绿（提亮）
    Color(1.00, 0.85, 0.18, 1.0),  -- 鲜黄（提亮）
}

-- 自发光强度大幅提升，让玩家在场景中更醒目
Config.PlayerEmissive = {
    Color(0.35, 0.06, 0.04),   -- 红光（原 0.12→0.35）
    Color(0.04, 0.12, 0.35),   -- 蓝光（原 0.12→0.35）
    Color(0.05, 0.30, 0.08),   -- 绿光（原 0.10→0.30）
    Color(0.35, 0.28, 0.04),   -- 黄光（原 0.12→0.35）
}
...
-- 方块颜色（温暖色调，提亮以抵消变灰）
Config.BlockColors = {
    [1] = Color(0.96, 0.93, 0.88, 1.0),   -- 普通：亮奶白（原 0.92→0.96）
    [2] = Color(0.38, 0.32, 0.28, 1.0),   -- 安全：浅巧克力灰（原 0.30→0.38）
    [3] = Color(0.42, 0.92, 0.88, 1.0),   -- 能量托台：亮薄荷绿（提亮）
    [4] = Color(0.52, 0.95, 0.48, 1.0),   -- 起点：亮暖绿（旧版兼容）
    [5] = Color(1.00, 0.82, 0.22, 1.0),   -- 终点：亮橙金（提亮）
    [10] = Color(1.00, 0.30, 0.25, 1.0),  -- P1 出生点：番茄红（同步提亮）
    [11] = Color(0.30, 0.55, 1.00, 1.0),  -- P2 出生点：宝蓝（同步提亮）
    [12] = Color(0.25, 0.95, 0.42, 1.0),  -- P3 出生点：翠绿（同步提亮）
    [13] = Color(1.00, 0.85, 0.18, 1.0),  -- P4 出生点：鲜黄（同步提亮）
}
...
-- 橡皮质感 PBR 参数（降低粗糙度，增强反光对抗变灰）
Config.RubberMetallic  = 0.03
Config.RubberRoughness = 0.55
