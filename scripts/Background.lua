...
-- 配色方案列表（Astroon 宇宙深色系）
-- 每个方案包含：渐变顶色、渐变底色、菱形颜色
local palettes_ = {
    -- 1: 宇宙紫（Astroon 主色调，提亮）
    {
        top    = { 0.25, 0.16, 0.52 },   -- 提亮 backgroundMid
        bottom = { 0.15, 0.10, 0.35 },   -- 提亮 background
        diamond = { 0.239, 0.839, 0.910, 0.25 },  -- $accent 青色菱形
    },
    -- 2: 深蓝星空（提亮）
    {
        top    = { 0.20, 0.17, 0.48 },   -- 提亮深蓝紫
        bottom = { 0.12, 0.09, 0.32 },   -- 提亮极深蓝
        diamond = { 0.290, 0.545, 0.961, 0.25 },  -- $secondary 蓝色菱形
    },
    -- 3: 金紫星云（提亮）
    {
        top    = { 0.27, 0.16, 0.48 },   -- 提亮偏暖紫
        bottom = { 0.16, 0.10, 0.35 },   -- 提亮深紫
        diamond = { 1.000, 0.835, 0.310, 0.22 },  -- $primary 金色菱形
    },
    -- 4: 翡翠深空（提亮）
    {
        top    = { 0.15, 0.18, 0.45 },   -- 提亮偏冷蓝紫
        bottom = { 0.10, 0.10, 0.32 },   -- 提亮深夜蓝
        diamond = { 0.180, 0.800, 0.443, 0.22 },  -- $success 翡翠菱形
    },
    -- 5: 珊瑚深渊（提亮）
    {
        top    = { 0.26, 0.15, 0.47 },   -- 提亮暖紫
        bottom = { 0.17, 0.09, 0.34 },   -- 提亮深紫红
        diamond = { 1.000, 0.278, 0.341, 0.20 },  -- $error 珊瑚菱形
    },
}
